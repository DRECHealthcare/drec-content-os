...
const checks = [
  ...
  },
  {
    ...
    validate: async (res) => {
      ...
      return text.includes("DREC")
        ...
        && text.includes("doctor-send-queue")
  ...
  },
  {
    ...
    validate: async (res) => {
      ...
      return text.includes("/operations/doctor-decision-worksheet.csv")
        ...
        && text.includes("/operations/doctor-review-bridge")
        ...
        && text.includes("/operations/doctor-reply-inbox-pack")
        && text.includes("/operations/doctor-reply-inbox-pack.md")
        && text.includes("loadDoctorSendQueue")
        && text.includes("renderDoctorSendQueue")
        && text.includes("data-copy-doctor-send")
        && text.includes("data-copy-doctor-full-message")
        && text.includes("data-copy-doctor-paste-back")
        && text.includes("data-copy-doctor-reply-template")
        && text.includes("data-copy-doctor-send-all")
        && text.includes("doctorSendBatchText")
        && text.includes("latestDoctorFullMessage")
        && text.includes("latestDoctorPasteBackTemplate")
        && text.includes("loadDoctorReplyInboxPack")
        && text.includes("renderDoctorReplyInboxPack")
        && text.includes("data-copy-doctor-inbox-reply")
        && text.includes("data-copy-doctor-inbox-all")
        && text.includes("doctorInboxBatchText")
  ...
  },
  {
    ...
    validate: async (res) => {
      const data = await res.json();
      return Boolean(data.outcome_insights?.summary)
        && Array.isArray(data.outcome_insights?.top_signals)
        && Array.isArray(data.suggested_learning_weights);
    },
  },
  {
